...
{{--                            <a href="{{route('login')}}"><button type="button" class="btn btn-success">Вход</button></a>--}}
{{--                            <a href="{{route('register')}}"><button type="button" class="btn btn-primary btn-reg">Регистарция</button></a>--}}
{{--                        </div>--}}
                    </div>
